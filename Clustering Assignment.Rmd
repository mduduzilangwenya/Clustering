...
# K-means clustering
# ==========
dia.df.num = model.matrix(~ Pregnancies + factor(gender) + Glucose +
                            BloodPressure + SkinThickness + Insulin + 
                            BMI + factor(Age) _ factor(Outcome),  data = diabetes)

## Scaling the data
####################

scaled_data = scale(seg.df.num[,-1])
...
seg.k3 <- kmeans(scaled_data, centers=3, nstart = 50, iter.max = 20 )

seg.summ(seg.df.num, seg.k3$cluster)
